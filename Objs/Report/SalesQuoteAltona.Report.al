report 50100 "Sales - Quote Altona"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/SalesQuoteAltona.rdlc';
    Caption = 'Sales - Quote Altona';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(BoardingCondition; "Boarding Condition")
            {
            }
            column(BoardingCondition_Lbl; FieldCaption("Boarding Condition"))
            {
            }
            ...
            Column(Comment_SalesComentLine; CommentLine)
            {
            }
            ...
            begin
                ...
                SalesCommentLine.SETRANGE("Document Type", Header."Document Type");
                SalesCommentLine.SETRANGE("No.", Header."No.");
                IF SalesCommentLine.FIND('-') THEN
                    REPEAT
                        CommentLine += FORMAT(SalesCommentLine.Date) + ' ' + SalesCommentLine.Comment + ' ';
